...
* fix: order dependabot security updates after vulnerability alerts and  solve deprecation (#113) @marwinbaumannsbp

**Full Changelog**: https://github.com/schubergphilis/terraform-github-mcaf-repository/compare/v6.0.1...v6.0.2
...
* fix: plaintext_value argument is deprecated (#112) @mlflr

**Full Changelog**: https://github.com/schubergphilis/terraform-github-mcaf-repository/compare/v6.0.0...v6.0.1
...
* feat!: migrate pages to the dedicated github_repository_pages resource (#110) @marwinbaumannsbp

#### 🧺 Miscellaneous

* chore: Move vulnerability_alerts to separate resource (#111) @fatbasstard

**Full Changelog**: https://github.com/schubergphilis/terraform-github-mcaf-repository/compare/v5.1.1...v6.0.0
...
* fix: var.workflow_permissions condition errors out when null (#109) @mlflr

**Full Changelog**: https://github.com/schubergphilis/terraform-github-mcaf-repository/compare/v5.1.0...v5.1.1
...
* fix!: remove deprecated attribute and thus variable (#106) @jorrite

**Full Changelog**: https://github.com/schubergphilis/terraform-github-mcaf-repository/compare/v4.8.0...v5.0.0
...
* feat: add support for github_workflow_repository_permissions (#104) @jorrite

**Full Changelog**: https://github.com/schubergphilis/terraform-github-mcaf-repository/compare/v4.7.1...v4.8.0
...
* fix: always set commit message and title (#105) @jorrite

**Full Changelog**: https://github.com/schubergphilis/terraform-github-mcaf-repository/compare/v4.7.0...v4.7.1
...
* feat: Support creating a forked repository (#103) @shoekstra

**Full Changelog**: https://github.com/schubergphilis/terraform-github-mcaf-repository/compare/v4.6.0...v4.7.0
...
* feat: add support for defining custom properties (#102) @skesarkar-schubergphilis

**Full Changelog**: https://github.com/schubergphilis/terraform-github-mcaf-repository/compare/v4.5.0...v4.6.0
...
* feat: Updates GitHub provider and pages validation (#101) @Plork

**Full Changelog**: https://github.com/schubergphilis/terraform-github-mcaf-repository/compare/v4.4.0...v4.5.0
...
* feat: Add support for custom autolink references (#100) @shoekstra

**Full Changelog**: https://github.com/schubergphilis/terraform-github-mcaf-repository/compare/v4.3.0...v4.4.0
...
* feat: add support for github pages 'workflow' build type (#99) @marwinbaumannsbp

**Full Changelog**: https://github.com/schubergphilis/terraform-github-mcaf-repository/compare/v4.2.0...v4.3.0
...
* feature: add support for github pages (#98) @marwinbaumannsbp

**Full Changelog**: https://github.com/schubergphilis/terraform-github-mcaf-repository/compare/v4.1.0...v4.2.0
...
* feat: add support for associating github apps with the repository (#97) @marwinbaumannsbp

**Full Changelog**: https://github.com/schubergphilis/terraform-github-mcaf-repository/compare/v4.0.0...v4.1.0
...
* feature: Add support for require_last_push_approval (#87) @stromp

**Full Changelog**: https://github.com/schubergphilis/terraform-github-mcaf-repository/compare/v2.1.1...v2.2.0
...
* fix: Ensure you do not enable dependabot when your vulnerability alerts are not (#86) @stromp

**Full Changelog**: https://github.com/schubergphilis/terraform-github-mcaf-repository/compare/v2.1.0...v2.1.1
...
* feat: Add Dependabot Security Updates support (#84) @shoekstra

#### 🐛 Bug Fixes

* fix: Set `var.vulnerability_alerts` default to true (#85) @shoekstra

**Full Changelog**: https://github.com/schubergphilis/terraform-github-mcaf-repository/compare/v2.0.0...v2.1.0
